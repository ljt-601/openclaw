...
complete -c openclaw -n "__fish_use_subcommand" -a "openclaw-weixin" -d 'Weixin channel utilities'
complete -c openclaw -n "__fish_use_subcommand" -a "memory-pro" -d 'Enhanced memory management commands (LanceDB Pro)'
complete -c openclaw -n "__fish_use_subcommand" -a "reindex-fts" -d 'Rebuild the BM25 full-text search index'
...
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l no-ascii -d 'Skip ASCII QR rendering'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from openclaw-weixin" -a "uninstall" -d 'Uninstall the Weixin plugin (cleans up channel config automatically)'
complete -c openclaw -n "__fish_seen_subcommand_from openclaw-weixin" -a "logs-upload" -d 'Upload a Weixin log file to a remote URL via HTTP POST'
complete -c openclaw -n "__fish_seen_subcommand_from logs-upload" -l url -d 'Remote URL to POST the log file to (overrides config)'
complete -c openclaw -n "__fish_seen_subcommand_from logs-upload" -l file -d 'Log file to upload: full filename or 8-digit date YYYYMMDD (default: today)'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "version" -d 'Print plugin version'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "list" -d 'List memories with optional filtering'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "search" -d 'Search memories using hybrid retrieval'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "stats" -d 'Show memory statistics'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "delete" -d 'Delete a specific memory by ID'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "delete-bulk" -d 'Bulk delete memories with filters'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "export" -d 'Export memories to JSON'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "import" -d 'Import memories from JSON file'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "reembed" -d 'Re-embed memories from a source LanceDB database into the current target database'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "upgrade" -d 'Upgrade legacy memories to new 6-category L0/L1/L2 smart memory format'
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "migrate" -d 'Migration utilities'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l scope -d 'Filter by scope'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l category -d 'Filter by category'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l limit -d 'Maximum number of results'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l offset -d 'Number of results to skip'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l scope -d 'Search within specific scope'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l category -d 'Filter by category'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l limit -d 'Maximum number of results'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from stats" -l scope -d 'Stats for specific scope'
complete -c openclaw -n "__fish_seen_subcommand_from stats" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l scope -d 'Scope to delete from (for access control)'
complete -c openclaw -n "__fish_seen_subcommand_from delete-bulk" -l scope -d 'Scopes to delete from (required)'
complete -c openclaw -n "__fish_seen_subcommand_from delete-bulk" -l before -d 'Delete memories before this date (YYYY-MM-DD)'
complete -c openclaw -n "__fish_seen_subcommand_from delete-bulk" -l dry-run -d 'Show what would be deleted without actually deleting'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l scope -d 'Export specific scope'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l category -d 'Export specific category'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l output -d 'Output file (default: stdout)'
complete -c openclaw -n "__fish_seen_subcommand_from import" -l scope -d 'Import into specific scope'
complete -c openclaw -n "__fish_seen_subcommand_from import" -l dry-run -d 'Show what would be imported without actually importing'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l source-db -d 'Source LanceDB database directory'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l batch-size -d 'Batch size for embedding calls'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l limit -d 'Limit number of rows to process (for testing)'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l dry-run -d 'Show what would be re-embedded without writing'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l skip-existing -d 'Skip entries whose id already exists in the target DB'
complete -c openclaw -n "__fish_seen_subcommand_from reembed" -l force -d 'Allow using the same source-db as the target dbPath (DANGEROUS)'
complete -c openclaw -n "__fish_seen_subcommand_from upgrade" -l dry-run -d 'Show upgrade statistics without modifying data'
complete -c openclaw -n "__fish_seen_subcommand_from upgrade" -l batch-size -d 'Number of memories per batch'
complete -c openclaw -n "__fish_seen_subcommand_from upgrade" -l no-llm -d 'Skip LLM calls; use simple text truncation for L0/L1'
complete -c openclaw -n "__fish_seen_subcommand_from upgrade" -l limit -d 'Maximum number of memories to upgrade'
complete -c openclaw -n "__fish_seen_subcommand_from upgrade" -l scope -d 'Only upgrade memories in this scope'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "check" -d 'Check if migration is needed from legacy memory-lancedb'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "run" -d 'Run migration from legacy memory-lancedb'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "verify" -d 'Verify migration results'
complete -c openclaw -n "__fish_seen_subcommand_from check" -l source -d 'Specific source database path'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l source -d 'Specific source database path'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l default-scope -d 'Default scope for migrated data'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l dry-run -d 'Show what would be migrated without actually migrating'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l skip-existing -d 'Skip entries that already exist'
complete -c openclaw -n "__fish_seen_subcommand_from verify" -l source -d 'Specific source database path'
