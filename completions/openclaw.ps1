...
Register-ArgumentCompleter -Native -CommandName openclaw -ScriptBlock {
    ...
    if ($commandPath -eq "") {
         ...
         $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
            ...
            if ($commandPath -eq 'openclaw-weixin') {
                $completions = @('uninstall','logs-upload')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }

            if ($commandPath -eq 'openclaw-weixin logs-upload') {
                $completions = @('--url','--file')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }

            if ($commandPath -eq 'memory-pro') {
            ...
            if ($commandPath -eq 'memory-pro list') {
            ...
            if ($commandPath -eq 'memory-pro search') {
            ...
            if ($commandPath -eq 'memory-pro stats') {
            ...
            if ($commandPath -eq 'memory-pro delete') {
                $completions = @('--scope')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'memory-pro delete-bulk') {
            ...
            if ($commandPath -eq 'memory-pro export') {
            ...
            if ($commandPath -eq 'memory-pro import') {
            ...
            if ($commandPath -eq 'memory-pro reembed') {
            ...
            if ($commandPath -eq 'memory-pro upgrade') {
            ...
            if ($commandPath -eq 'memory-pro migrate') {
            ...
            if ($commandPath -eq 'memory-pro migrate check') {
                $completions = @('--source')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'memory-pro migrate run') {
            ...
            if ($commandPath -eq 'memory-pro migrate verify') {
                $completions = @('--source')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
